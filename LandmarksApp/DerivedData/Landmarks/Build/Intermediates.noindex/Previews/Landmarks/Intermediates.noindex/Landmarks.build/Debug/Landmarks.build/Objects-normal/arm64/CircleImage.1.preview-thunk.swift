...
extension CircleImage {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        Image(__designTimeString("#4545.[1].[0].property.[0].[0].arg[0].value", fallback: "turtlerock"))
            .clipShape(Circle())
            .overlay{
                Circle().stroke(.white, lineWidth: __designTimeInteger("#4545.[1].[0].property.[0].[0].modifier[1].arg[0].value.[0].modifier[0].arg[1].value", fallback: 4))
            }
            .shadow(radius: __designTimeInteger("#4545.[1].[0].property.[0].[0].modifier[2].arg[0].value", fallback: 7))
